/**
  ...
  ******************************************************************************
  */
#ifndef AI_BREATH_MLP_H
#define AI_BREATH_MLP_H

#include "breath_mlp_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_BREATH_MLP_MODEL_NAME          "breath_mlp"
#define AI_BREATH_MLP_ORIGIN_MODEL_NAME   "mlp_200ms_mfcc_delta_full56"

/******************************************************************************/
#define AI_BREATH_MLP_ACTIVATIONS_ALIGNMENT   (4)
#define AI_BREATH_MLP_INPUTS_IN_ACTIVATIONS   (4)
#define AI_BREATH_MLP_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_BREATH_MLP_IN_NUM        (1)

AI_DEPRECATED
#define AI_BREATH_MLP_IN \
  ai_breath_mlp_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_BREATH_MLP_IN_SIZE { \
  AI_BREATH_MLP_IN_1_SIZE, \
}
#define AI_BREATH_MLP_IN_SIZE_BYTES { \
  AI_BREATH_MLP_IN_1_SIZE_BYTES, \
}
#define AI_BREATH_MLP_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_BREATH_MLP_IN_1_CHANNEL     (56)
#define AI_BREATH_MLP_IN_1_SIZE        (56)
#define AI_BREATH_MLP_IN_1_SIZE_BYTES  (224)

/******************************************************************************/
#define AI_BREATH_MLP_OUT_NUM       (1)

AI_DEPRECATED
#define AI_BREATH_MLP_OUT \
  ai_breath_mlp_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_BREATH_MLP_OUT_SIZE { \
  AI_BREATH_MLP_OUT_1_SIZE, \
}
#define AI_BREATH_MLP_OUT_SIZE_BYTES { \
  AI_BREATH_MLP_OUT_1_SIZE_BYTES, \
}
#define AI_BREATH_MLP_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_BREATH_MLP_OUT_1_CHANNEL     (5)
#define AI_BREATH_MLP_OUT_1_SIZE        (5)
#define AI_BREATH_MLP_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_BREATH_MLP_N_NODES (7)
 ...
 * @ref ai_breath_mlp_create. Both the activations memory buffer 
 ...
 * using @ref ai_breath_mlp_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_breath_mlp_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_breath_mlp_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_BREATH_MLP_*
 * defines into file @ref breath_mlp.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_breath_mlp_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_BREATH_MLP_H */
